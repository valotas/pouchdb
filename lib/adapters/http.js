...
function HttpPouch(opts, callback) {
  ...
  api.allDocs = utils.adapterFun('allDocs', function (opts, callback) {
    ...
    // If opts.inclusive_end exists and is false, added to the parameters.
    // Otherwise the default value (true) should be used by couchdb
    if (opts.inclusive_end === false) {
      params.push('inclusive_end=false');
    }
